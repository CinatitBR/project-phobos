...
const addToLibrary = (pdfId, userId) => 
  axiosInstance.post('/pdf/add-to-library', { pdfId, userId })

const removeFromLibrary = (pdfId, userId) => 
  axiosInstance.post('/pdf/remove-from-library', { pdfId, userId })
